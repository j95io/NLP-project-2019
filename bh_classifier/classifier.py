...
This works on the last version of fastai: 1.0.61
Spacy is reuquired. spacy == 2.3.5 works, not sure about higher or lower versions
torch 1.8.1 works with it.
"""
...
learn = load_learner('./', 'trained_classifier.pkl')
...
if __name__ == "__main__":
    ...
    ThreadedServer(ClassifierService, port=PORT).start()
